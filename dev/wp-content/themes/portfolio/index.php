...
?>
          ...
          <section class="whati">
            ...
            <div class="whati__box whati__wrap-parralax">
              <img class="whati__clavier" data-stellar-ratio="0.85" src="<?php echo get_template_directory_uri() . '/assets/img/logo_home/clavier.svg';?>" alt="">
              <img class="whati__airmail" data-stellar-ratio="1.25" src="<?php echo get_template_directory_uri() . '/assets/img/logo_home/airmail.svg';?>" alt="">
              <img class="whati__ipad" data-stellar-ratio="0.85" src="<?php echo get_template_directory_uri() . '/assets/img/logo_home/ipad.svg';?>" alt="">
              ...
              <img class="whati__ordinateur" data-stellar-ratio="0.9" src="<?php echo get_template_directory_uri() . '/assets/img/logo_home/ordinateur.svg';?>" alt="">
              <img class="whati__souris" data-stellar-ratio="1.25" src="<?php echo get_template_directory_uri() . '/assets/img/logo_home/souris.svg';?>" alt="">
              <img class="whati__telephone" data-stellar-ratio="0.85" src="<?php echo get_template_directory_uri() . '/assets/img/logo_home/telephone.svg';?>" alt="">
